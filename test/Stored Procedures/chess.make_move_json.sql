CREATE proc [test].[chess.make_move_json]
as
...
set @board_json = chess.json_board_from_fen('1k6/8/8/2Q3n1/8/8/2K5/8 w - - 0 1')

set @new_board = [chess].[make_move_json](@board_json, 2, 4, 3, 5)
...
set @new_board = [chess].[make_move_json](@new_board, 3, 5, 2, 4)
...
set @new_board = [chess].[make_move_json](@new_board, 2, 4, 6, 4)
